...
class EqOperation(ComparisonOperation):
    ...
    def convert_to_elasticsearch(
        ...
        assert not isinstance(
            self.comparison_value, list
        ), "Use '$in' operation for lists as comparison values."
...
class NeOperation(ComparisonOperation):
    ...
    def convert_to_elasticsearch(
        ...
        assert not isinstance(
            self.comparison_value, list
        ), "Use '$nin' operation for lists as comparison values."
        return {
...
class GtOperation(ComparisonOperation):
    ...
    def convert_to_elasticsearch(
        ...
        assert not isinstance(
            self.comparison_value, list
        ), "Comparison value for '$gt' operation must not be a list."
...
class LtOperation(ComparisonOperation):
    ...
    def convert_to_elasticsearch(
        ...
        assert not isinstance(
            self.comparison_value, list
        ), "Comparison value for '$lt' operation must not be a list."
