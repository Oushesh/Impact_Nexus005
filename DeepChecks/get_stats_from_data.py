...
def load_properties(as_train_test: bool = True):
...
if __name__ == "__main__":
    ...
    data = read_and_save_data(assets_dir, file_name, url_to_file, file_type='csv', to_numpy=False, include_index=True)
    dataset=load_data(as_train_test=False)
